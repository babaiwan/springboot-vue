package com.springboot.utils.Captcha;

import com.springboot.utils.Captcha.CommonUtils.CommonUtil;
...
public class NoiseLine {
    ...
    public NoiseLine() {
        ...
        int y = 0;
        try {
            final BufferedImage img = ImageIO.read(new File("C:\\Users\\zjj\\Desktop\\Verification Code\\need.png"));
            this.renderImg = img;
    ...
    public void saveImg() {
        try {
            ImageIO.write(this.renderImg, "PNG", new File("C:\\Users\\zjj\\Desktop\\Verification Code\\handle.png"));
        } catch (final IOException e) {
            e.printStackTrace();
        }
    }
